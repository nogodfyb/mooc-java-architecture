...
public class ConfigDb132 {
    ...
    public DataSource db132(){
        ...
        xaDataSource.setPassword("apsmfg5566");
        xaDataSource.setUrl("jdbc:mysql://localhost:3306/xa_132?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
