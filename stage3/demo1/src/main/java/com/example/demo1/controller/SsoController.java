...
import com.example.demo1.common.CommonResult;
import com.example.demo1.entity.User;
import com.example.demo1.service.IUserService;
import com.example.demo1.util.JsonUtils;
import com.example.demo1.util.MD5Utils;
import com.example.demo1.util.RedisOperator;
import com.example.demo1.vo.UsersVO;
...
public class SsoController {
    ...
    public String doLogin(String username,
        ...
        redisOperator.set(REDIS_USER_TICKET + ":" + userTicket, userResult.getId().toString());
...
//        return "login";
    ...
    public CommonResult verifyTmpTicket(String tmpTicket,
        ...
        // 验证成功，返回OK，携带用户会话
        return CommonResult.success(JsonUtils.jsonToPojo(userRedis, UsersVO.class));
    }
